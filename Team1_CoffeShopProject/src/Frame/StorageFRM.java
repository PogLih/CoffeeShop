...
public class StorageFRM extends javax.swing.JFrame {
    ...
    List<Storage> list = strDAO.findbyid(0);
    ...
    void load() {
        try {
            ...
            model.setRowCount(0);
            for (Storage str : list) {
                Object[] row = {str.getId(), str.getQuantity()};
                model.addRow(row);
            }
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        kGradientPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 0, 150, 90));
        kGradientPanel2.add(txtID, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 9, 400, 70));
        ...
        kGradientPanel2.add(txtQuantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 10, 410, 70));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        // TODO add your handling code here:
        try {
            if (isNullOrEmpty(txtID.getText()) == false) {
                DialogHelper.alert(this, "Hãy nhập Id");
                return;
            }
            if (isNullOrEmpty(txtQuantity.getText()) == false) {
                DialogHelper.alert(this, "Hãy nhập Quantity");
                return;
            }
            if (isNumberic(txtID.getText()) == false) {
                DialogHelper.alert(this, "chỉ nhập số");
                return;
            }
            if (isNumberic(txtQuantity.getText()) == false) {
                DialogHelper.alert(this, "chỉ nhập số");
                return;
            }
            if (strDAO.check(Integer.parseInt(txtID.getText())) == true) {
                DialogHelper.alert(this, "Trùng id");
                return;
            }

            strDAO.insert(Integer.parseInt(txtID.getText()), Integer.parseInt(txtQuantity.getText()));
            DialogHelper.alert(this, "Thêm thành công");
            list = strDAO.findbyid(0);
            load();
        } catch (Exception e) {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            ...
            Storage str = new Storage(Integer.parseInt(txtID.getText()), Integer.parseInt(txtQuantity.getText()));
            strDAO.update(str);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        // TODO add your handling code here:
        try {
            strDAO.delete(tblStorage.getValueAt(tblStorage.getSelectedRow(), 0).toString());
    ...
    private void jTextField3KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField3KeyReleased
        try {
            list = strDAO.findbyid(Integer.parseInt(jTextField3.getText()));
            load();
        } catch (Exception e) {
        }
...
jTextField3.setText(null);        // TODO add your handling code here:
    ...
    private void tblStorageMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblStorageMouseClicked
        // TODO add your handling code here:
        int id = (Integer) tblStorage.getValueAt(tblStorage.getSelectedRow(), 0);
//        System.out.println(id);
        List<Storage> list = strDAO.findbyid(id);
        for (Storage dr : list) {
            
           
            txtID.setText(String.valueOf(dr.getId()));
            txtQuantity.setText(String.valueOf(dr.getQuantity()));
        }
